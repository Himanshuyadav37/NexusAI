  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-left">
        ...
        <p>NexusAI combines multiple specialized AI modules into one intelligent platform for software engineering, research, education and workflow automation.</p>
